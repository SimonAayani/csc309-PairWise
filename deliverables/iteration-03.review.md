...
>* **Search feature**
>     * Although many features of the PairWise product were not implemented for functionality, one of the main features to prioritize for future iterations would be a search feature that displayed results of students based on the user’s search criteria. These search results should be displayed in a page that lets the user view all results, and look into each individual’s profile to send potential invites. 
